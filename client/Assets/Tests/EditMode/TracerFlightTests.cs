...
namespace Ring.Simulation.Tests
{
    ...
    public class TracerFlightTests
    {
        ...
        /// ровно туда, куда его не пустил шаг. Это ассерт по той копии, которую
        /// читает потребитель (урок 644): рендерер блендит `Pos` и `PrevPos`.
        ///
        ...
        public void AClockJumpBackwards_ResetsTheCache_WHERETHEPATHISNOTSTRAIGHT()
        {
            ...
            // ПРЫЖОК ЧАСОВ НАЗАД: `NetConfig.RenderClockSnapTicks` равен десяти
            // именно потому, что часы действительно прыгают.
            t.StepTo(104);
