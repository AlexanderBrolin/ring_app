...
- **Мутации фазы убиты и предсказания сверены:** шесть (Т13), четыре (Т14),
  ...
  **три (Т20** — M20, M21, M41-слот правила 10**)**, **одиннадцать (Т22** — M22,
  M22a, M23, M23a, M24, M25, M26 плюс круг правок по ревью: **M22b** спилл
  реципроков в слоты сборщиков, **M22c** снятый сторож равных ключей, **M22d**
  снятый пропуск тела нулевого радиуса, **M22e** ветка толчка по режиму
  движения**)**, **две (Т23** — **M42** `>` -> `>=` в `ReqAtMost`, **M43** снятая
  мобья половина правила 13; вторая — требование рулинга 120, план считал одну**)**
  — **ТРИДЦАТЬ ЧЕТЫРЕ**.
